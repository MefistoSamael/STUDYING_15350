...
Нумерация лабораторных работ в пдфнике c условиями и номерами выполненных лабораторных отличются. Поэтому ниже приведен список, в котором указано какому условию лабораторной соответсвует какое решение
